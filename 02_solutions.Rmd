...
There was no improvement among adults until $q_0$ dropped to around .015? Then adjults made fast imrovements and infants hardly any.
```{r}
CZLT |> 
  group_by(year) |> 
